...
<template>
  <div class="container">
    ...
    <p class="subcaption">Please register below, to access your todolist.</p>

    <form class="input-container" @submit.prevent="onSubmit">
      <div class="login-input-wrapper">
        <input class="login-input" type="text" v-model="form.name" placeholder="Bruce Wayne" />
      </div>
      <div class="login-input-wrapper">
        <input
          class="login-input"
    ...
    <div class="confirmation-caption" style="text-align: center">
      <p>
        ...
        <span>
          <RouterLink to="/login"> <a>Sign in instead</a></RouterLink></span
        >
      </p>
    </div>
